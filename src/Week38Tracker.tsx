...
const week38Plan: PlanDay[] = [
  {
    date: "Mon March 16 • Week 38",
  ...
  {
    date: "Wed March 18 • Week 38",
    label: "LEGS + Core",
    exercises: [
      { name: "Sauna", sets: 1, reps: "15 min" },
      { name: "Hack Squat", sets: 4, reps: "10" },
      { name: "Step Ups (Dumbbell)", sets: 3, reps: "10/leg" },
  ...
  {
    date: "Sat March 21 • Week 38",
    label: "CONDITIONING + Core",
    exercises: [
      { name: "Sauna", sets: 1, reps: "15 min" },
      { name: "Incline Treadmill Walk", sets: 1, reps: "35-45 min" },
      { name: "Farmer Carry", sets: 3, reps: "40 sec" },
      { name: "Dead Bug", sets: 3, reps: "20" },
      { name: "Plank", sets: 3, reps: "45 sec" },
    ],
  },
  {
    date: "Sun March 22 • Week 38",
    label: "RECOVERY",
    exercises: [
      { name: "Sauna", sets: 1, reps: "15 min" },
...
const logKey = (week: number) => `w38log_w${week}`;
const recKey = (week: number, dayLabel: string) => `w38rec_w${week}_${dayLabel}`;
...
export default function Week38Tracker() {
  ...
  const weekPlan = useMemo(() => week38Plan, []);
