...
const week21Plan = rawPlan.map((entry, idx) => {
...
export default function Week21Tracker() {
  ...
  return (
    <ScrollArea className="p-4 max-w-md mx-auto space-y-4">
      {week21Plan.map(({ day, gym, outdoor, repTarget }: any) => (
        <Card key={day}>
                    ...
                    return (
                      <div key={key} className="border rounded p-2">
                        ...
                        <div className="mb-2 text-sm">
                          ...
                          <input type="text" value={state.machine || ""} placeholder="e.g. Cable #3 / Smith" className="w-full border rounded px-2 py-1 text-sm" onChange={(e) => updateMachine(key, e.target.value)} />
                        </div>
