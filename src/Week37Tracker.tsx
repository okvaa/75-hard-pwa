...
const week37Plan: PlanDay[] = [
  {
    date: "Mon March 9 • Week 37",
    label: "Back Width",
    exercises: [
  ...
  {
    date: "Sat March 14 • Week 37",
    label: "CONDITIONING",
    exercises: [
      { name: "Incline Treadmill Walk", sets: 1, reps: "30-45 min" },
...
export default function Week37Tracker() {
  ...
  const weekPlan = useMemo(() => week37Plan, []);
